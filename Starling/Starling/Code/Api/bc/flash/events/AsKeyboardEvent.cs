...
namespace bc.flash.events
{
	public class AsKeyboardEvent : AsEvent
	{
		...
		public virtual void update(uint charCode, uint keyCode, uint keyLocation, bool ctrlKey, bool altKey, bool shiftKey)
		{
			mCharCode = charCode;
			mKeyCode = keyCode;
			mKeyLocation = keyLocation;
		...
		public virtual void update(uint charCode, uint keyCode, uint keyLocation, bool ctrlKey, bool altKey)
		{
			update(charCode, keyCode, keyLocation, ctrlKey, altKey, false);
		}
		public virtual void update(uint charCode, uint keyCode, uint keyLocation, bool ctrlKey)
		{
			update(charCode, keyCode, keyLocation, ctrlKey, false, false);
		}
		public virtual void update(uint charCode, uint keyCode, uint keyLocation)
		{
			update(charCode, keyCode, keyLocation, false, false, false);
		}
		public virtual void update(uint charCode, uint keyCode)
		{
			update(charCode, keyCode, (uint)(0), false, false, false);
		}
		public virtual void update(uint charCode)
		{
			update(charCode, (uint)(0), (uint)(0), false, false, false);
		}
		public virtual void update()
		{
			update((uint)(0), (uint)(0), (uint)(0), false, false, false);
		}
